...
module CheckboxItem = {
  ...
  let make = (
    ...
    <BaseUi.Menu.CheckboxItem
      ...
      className={cn(
        "focus:bg-accent focus:text-accent-foreground focus:**:text-accent-foreground relative flex cursor-default items-center gap-1.5 rounded-md py-1 pe-8 ps-1.5 text-sm outline-hidden select-none data-disabled:pointer-events-none data-disabled:opacity-50 data-inset:ps-7 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
        className,
      )}
    >
      <span
...
module SubTrigger = {
  ...
  let make = (
    ...
    >
      {children}
      <Icons.ChevronRight className="cn-rtl-flip ms-auto" />
    </BaseUi.Menu.SubmenuTrigger>
}
