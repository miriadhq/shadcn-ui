...
let make = () => {
  ...
  >
    <div className="flex items-center justify-between gap-4 px-4">
      ...
      <Collapsible.Trigger render={<Button variant=Button.Variant.Ghost size=Button.Size.Icon className="size-8" />}>
    ...
    <Collapsible.Content className="flex flex-col gap-2">
      ...
      <div className="rounded-md border px-4 py-2 text-sm">
        ...
        <p className="text-muted-foreground"> {"2x سماعات الاستوديو"->React.string} </p>
      </div>
    </Collapsible.Content>
  </Collapsible>
}
