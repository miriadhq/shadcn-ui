    ...
    <form>
      <Field.Group>
        <Field.Set>
          ...
          <Field.Description>
            {"All transactions are secure and encrypted"->React.string}
          </Field.Description>
          <Field.Group>
            <Field>
              <Field.Label htmlFor="checkout-7j9-card-name-43j">
                {"Name on Card"->React.string}
              </Field.Label>
              <Input id="checkout-7j9-card-name-43j" placeholder="Evil Rabbit" required={true}>
                {React.null}
              </Input>
            </Field>
            <Field>
              <Field.Label htmlFor="checkout-7j9-card-number-uw1">
                {"Card Number"->React.string}
              </Field.Label>
              <Input
                id="checkout-7j9-card-number-uw1" placeholder="1234 5678 9012 3456" required={true}
              >
                {React.null}
              </Input>
              <Field.Description>
                {"Enter your 16-digit card number"->React.string}
              </Field.Description>
            </Field>
        ...
        <Field.Set>
          <Field.Group>
            <Field>
              <Field.Label htmlFor="checkout-7j9-optional-comments">
