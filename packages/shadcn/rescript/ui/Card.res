...
module Header = {
  ...
  let make = (~className="", ~children=?, ~id=?, ~style=?, ~onClick=?, ~onKeyDown=?) => {
    ...
    <div
      ?id ?children ?style ?onClick ?onKeyDown dataSlot="card-header" className=resolvedClassName
    />
  }
}
...
module Title = {
  ...
  let make = (~className="", ~children=?, ~id=?, ~style=?, ~onClick=?, ~onKeyDown=?) => {
    ...
    <div
      ?id ?children ?style ?onClick ?onKeyDown dataSlot="card-title" className=resolvedClassName
    />
  }
}
...
module Action = {
  ...
  let make = (~className="", ~children=?, ~id=?, ~style=?, ~onClick=?, ~onKeyDown=?) => {
    ...
    <div
      ?id ?children ?style ?onClick ?onKeyDown dataSlot="card-action" className=resolvedClassName
    />
  }
}
...
module Content = {
  ...
  let make = (~className="", ~children=?, ~id=?, ~style=?, ~onClick=?, ~onKeyDown=?) => {
    ...
    <div
      ?id ?children ?style ?onClick ?onKeyDown dataSlot="card-content" className=resolvedClassName
    />
  }
}
...
module Footer = {
  ...
  let make = (~className="", ~children=?, ~id=?, ~style=?, ~onClick=?, ~onKeyDown=?) => {
    ...
    <div
      ?id ?children ?style ?onClick ?onKeyDown dataSlot="card-footer" className=resolvedClassName
    />
  }
}
